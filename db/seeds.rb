...
t2 = Tour.create!(name: "Muir Woods and Sausalito Half Day Tour", 
    ...
    additional_info: ["Confirmation will be received at time of booking", "Wheelchair accessible. However, passengers in a wheelchair can be accommodated only if they can get on and off the bus on their own and if the wheelchair is foldable.", "Wheelchair accessible", "Near public transportation", "Near public transportation", "Near public transportation", "Please note that Departure times can vary from day to day depending on our parking assignments.", "Most travelers can participate", "This tour/activity will have a maximum of 40 travelers" ], 
    spaces_available: 40, 
    location_id: 1, 
